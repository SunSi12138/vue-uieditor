    ...
    , link: function (href, fn, cssname) {
      ...
      (function poll() {
        if (++timeout > 8 * 1000 / 100) {
          return window.console && console.error('laydate-uieditor.css: Invalid');
        };
    ...
    , laydate = {
      ...
      , ready: function (fn) {
        var cssname = 'laydate', ver = ''
          , path = (isLayui ? 'modules/laydate/' : 'theme/') + 'default/laydate-uieditor.css?v=' + laydate.v + ver;
  ...
  */
  ...
  Class.prototype.render = function () {
    ...
    if (isStatic) {
      ...
      var $ = layui.$;
      var dateContant = $('#laydateUiEditorContant');
      if (dateContant.size() >= 0) {
        dateContant = $('<div id="laydateUiEditorContant" class="layui-uieditor" />');
        dateContant.appendTo(document.body);
      }
      dateContant.append(elem);
    }
    that.position();
